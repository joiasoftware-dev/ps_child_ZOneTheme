...
class PrestaHelper {
	...
	public $headers, $body;
	public static $id_content_global,$id_content_primary_global,$id_editor_global, $hook_current, $id_lang_global, $id_shop_global, $disable_activity, $current_error;
...
<?php
		return array(
			...
			CRAZY_ASSETS_URL . 'lib/jquery-ui/jquery.ui.draggable.min.js',
			CRAZY_ASSETS_URL . 'lib/jquery-ui/jquery.ui.position.min.js',
			CRAZY_ASSETS_URL . 'lib/jquery-ui/jquery.ui.sortable.min.js',
