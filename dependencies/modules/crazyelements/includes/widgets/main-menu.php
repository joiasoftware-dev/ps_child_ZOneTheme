	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'raw' => PrestaHelper::__( 'To addd margin padding <a href="https://classydevs.com/prestashop-page-builder/pricing/?utm_source=crazyfree&utm_medium=crazyfree_module&utm_campaign=crazyfree&utm_term=crazyfree&utm_content=crazyfree" target="_blank">Get The PRO</a> version of Crazy Elements', 'elementor' ),
...
?>
			...
			?>
		">
					<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#crazy_menu_list<?php echo $menu_toggle_id; ?>">
						<?php
						if ($header_icon) {
					...
					if ($logo_img) {
					?>
						<a class="navbar-brand" <?php echo $target_value . $rel_value; ?> href="<?php echo $brand_link['url']; ?>"><img src="<?php echo $logo_img; ?>"></a>
					<?php
					} else {
					?>
						<a class="brand-name navbar-brand" <?php echo $target_value . $rel_value; ?> href="<?php echo $brand_link['url']; ?>"><?php echo $brand_name; ?></a>
					<?php
					}
					?>
				</div>
				<div class="crazy-menu <?php echo $settings['menu_alignment']; ?> collapse navbar-collapse" id="crazy_menu_list<?php echo $menu_toggle_id; ?>">
					<?php echo $output; ?>
				</div>
			</nav>
<?php
