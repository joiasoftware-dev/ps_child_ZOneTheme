...
class Widget_Tabs extends Widget_Base {
	...
	public function get_title() {
		return PrestaHelper::__( 'Tabs', 'elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_tabs',
			[
				'label' => PrestaHelper::__( 'Tabs', 'elementor' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => PrestaHelper::__( 'Tab Title', 'elementor' ),
				'placeholder' => PrestaHelper::__( 'Tab Title', 'elementor' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => PrestaHelper::__( 'Tab Content', 'elementor' ),
				'placeholder' => PrestaHelper::__( 'Tab Content', 'elementor' ),
		...
		$this->add_control(
			'tabs',
			[
				'label' => PrestaHelper::__( 'Tabs Items', 'elementor' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => PrestaHelper::__( 'Tab #1', 'elementor' ),
					...
					[
						'tab_title' => PrestaHelper::__( 'Tab #2', 'elementor' ),
						'tab_content' => PrestaHelper::__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'elementor' ),
					],
				],
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'options' => [
					'horizontal' => PrestaHelper::__( 'Horizontal', 'elementor' ),
					'vertical' => PrestaHelper::__( 'Vertical', 'elementor' ),
				],
		...
		$this->add_control(
			'navigation_width',
			[
				'label' => PrestaHelper::__( 'Navigation Width', 'elementor' ),
