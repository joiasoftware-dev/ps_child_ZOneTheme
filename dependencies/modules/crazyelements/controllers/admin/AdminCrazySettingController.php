	...
	public function renderList() {
        ...
        <div class="panel " id="configuration_fieldset_replace"> <div class="panel-heading"> <i class="icon-cogs"></i> Homepage Settings</div><div class="form-wrapper"> 
			<div class="form-group">
				...
				<div class="col-lg-9 col-lg-offset-3"> <div class="help-block"><a href="https://classydevs.com/prestashop-page-builder/pricing/">Get Crazyelements Pro</a> And Select Layout for your Homepage</div></div>
			</div>
			<div class="form-group"> 
